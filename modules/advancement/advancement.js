 ...
 *
 * @property {WonderItem} item    Item to which this advancement belongs.
...
export class Advancement {
  ...
  static get metadata() {
    return {
      ...
      title: game.i18n.localize('WonderSystem.AdvancementTitle'),
      hint: '',
      multiLevel: false,
   ...
   * @param {WonderItem} item  Item to check against.
